    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md">
      <div className="relative w-full max-w-5xl bg-[#091527] border border-amber-500/40 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
          ...
          {/* 1. LOGIN SCREEN VIA GOOGLE */}
          {!currentUser ? (
            <div className="max-w-md mx-auto py-8 sm:py-12 text-center space-y-6">
              <div className="w-20 h-20 mx-auto rounded-3xl bg-amber-400/10 border border-amber-400/30 flex items-center justify-center p-3 shadow-inner">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  Para gerenciar os passeios cadastrados, atualizar preços, fotos e vagas em tempo real, efetue login com a sua Conta Google de administrador.
                </p>
              </div>
              ...
              <button
                ...
                className="w-full py-3.5 px-6 rounded-2xl font-bold text-sm text-slate-950 bg-gradient-to-r from-amber-300 via-amber-400 to-yellow-500 hover:from-amber-200 hover:to-amber-400 transition-all flex items-center justify-center gap-3 shadow-[0_0_25px_rgba(245,158,11,0.35)] disabled:opacity-50"
              >
                {authLoading ? (
            ...
            /* Logged in, but not the authorized Admin email */
            <div className="max-w-md mx-auto py-10 text-center space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <button
                  onClick={onClose}
                  className="flex-1 py-3 px-4 rounded-xl bg-slate-900 border border-slate-700 text-slate-300 hover:text-white font-semibold text-xs transition-colors"
                >
                  Voltar ao Site
                </button>
              </div>
